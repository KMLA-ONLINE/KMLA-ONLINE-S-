          ...
          and (
            ...
            or exists (
              ...
              where viewer.id = p_profile_id
                ...
                and viewer.cohort = timeline.cohort
...
DROP FUNCTION private.feed_rank_time(p_published_at timestamp WITH time zone, p_bumped_at timestamp WITH time zone, p_feed_epoch timestamp
  WITH time zone, p_reaction_count integer, p_ranking_comment_count integer, p_is_cross_timeline boolean);
...
REVOKE ALL ON FUNCTION private.feed_rank_time(timestamp WITH time zone, timestamp WITH time zone, timestamp WITH time zone, integer, integer, boolean, boolean) FROM PUBLIC;
