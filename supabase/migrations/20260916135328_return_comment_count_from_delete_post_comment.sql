...
DROP FUNCTION public.delete_post_comment(p_comment_id uuid);

CREATE FUNCTION public.delete_post_comment (
  p_comment_id uuid
)
  RETURNS integer
  LANGUAGE plpgsql
...
GRANT ALL ON FUNCTION public.delete_post_comment(uuid) TO authenticated;