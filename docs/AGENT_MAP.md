...
| `/theme`                             | `app/routes/theme.tsx`                      | —                             | —     | —                                               | none             | —                                                                                  |
...
| `/profile`                           | `app/routes/app/profile/index.tsx`          | sticky/sticky/4xl             | —     | app-shell                                       | §12.1            | —                                                                                  |
...
| `/menu/birthdays`                    | `app/routes/app/menu/birthdays.tsx`         | sticky/sticky/5xl             | L     | profiles                                        | §17.5, §17.8     | `test/routes/app/menu/birthdays.test.ts`                                           |
...
| `/support`                           | `app/routes/app/support.tsx`                | sticky/sticky/2xl             | —     | support                                         | §15.11           | —                                                                                  |
| `/update`                            | `app/routes/app/update.tsx`                 | sticky/sticky/2xl             | —     | support                                         | §15.12           | —                                                                                  |
...
| `/profile/:pubId`                    | `app/routes/app/profile/detail.tsx`         | sticky/sticky/5xl             | L A S | profiles, posts                                 | §12.1, §12.4     | `test/routes/app/profile/detail.test.ts`                                           |
