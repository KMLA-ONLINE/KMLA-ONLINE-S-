import { mockFeedPosts } from "~/domains/feed/mock";
import type { FeedPost } from "~/domains/feed/model/types";
 ...
 *
 * ─── 지금은 mock이다 ───────────────────────────────────────────────────────────
 * `list_feed_posts()` RPC가 아직 없다. 생기면 `~/domains/feed/mock`을 지우고 본문을 이걸로 바꾼다:
 *
 * ```ts
