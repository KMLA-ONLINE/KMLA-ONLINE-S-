...
import { NavBadge } from "~/domains/shell/components/nav-badge";
import { isNavItemActive, navItems } from "~/domains/shell/model/nav-items";
import { useNavBadges } from "~/domains/shell/model/shell-data";
