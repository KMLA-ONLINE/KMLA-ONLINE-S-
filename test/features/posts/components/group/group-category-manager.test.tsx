...
import { GroupCategoryManager } from "~/features/posts/components/group/group-category-manager";
...
function renderManager(options?: Parameters<typeof renderRoute>[1]) {
  return renderRoute(
    () => <GroupCategoryManager groupId="group-1" categories={categories} />,
    options,
  );
}
